...
public class CheckersBoardServerGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CheckersBoardServerGUI(int port) {
		server = null;
		setTitle("Checkers Server");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 644, 475);
		setSize(new Dimension(890, 692));
		setResizable(false);
		...
		gbl_contentPane.columnWidths = new int[] { 296, 0 };
		...
		gbl_panelConnection.columnWidths = new int[] { 0, 0, 0, 0 };
		gbl_panelConnection.rowHeights = new int[] { 0, 0 };
		gbl_panelConnection.columnWeights = new double[] { 0.0, 1.0, 0.0,
				Double.MIN_VALUE };
		...
		tPortNumber = new JTextField();
		tPortNumber.setText("1500");
		GridBagConstraints gbc_tPortNumber = new GridBagConstraints();
		gbc_tPortNumber.anchor = GridBagConstraints.NORTH;
		gbc_tPortNumber.insets = new Insets(0, 0, 0, 5);
		gbc_tPortNumber.fill = GridBagConstraints.HORIZONTAL;
		gbc_tPortNumber.gridx = 1;
		gbc_tPortNumber.gridy = 0;
		panelConnection.add(tPortNumber, gbc_tPortNumber);
		tPortNumber.setColumns(10);

		button = new JButton("Start");
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actionPerformedFunction(e);
			}
		});
		GridBagConstraints gbc_button = new GridBagConstraints();
		gbc_button.gridx = 2;
		gbc_button.gridy = 0;
		panelConnection.add(button, gbc_button);
		...
		gbl_panel_1.columnWidths = new int[]{296, 122, 0};
		...
		panel_1.add(panelBoard, gbc_panelBoard);
		...
		gbl_panelBoard.columnWidths = new int[] { 32, 0, 0, 0, 0, 0, 0, 0, 0, 0 };
		gbl_panelBoard.rowHeights = new int[] { 20, 0, 0, 0, 0, 0, 0, 0, 0, 0 };
		...
		label01 = new JLabel("");
		label01.setName("01");
		label01.setIcon(new ImageIcon(CheckersBoardServerGUI.class
		...
		label03 = new JLabel("");
		label03.setName("03");
		label03.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label05 = new JLabel("");
		label05.setName("05");
		label05.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label07 = new JLabel("");
		label07.setName("07");
		label07.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label10 = new JLabel("");
		label10.setName("10");
		label10.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label12 = new JLabel("");
		label12.setName("12");
		label12.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label14 = new JLabel("");
		label14.setName("14");
		label14.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label16 = new JLabel("");
		label16.setName("16");
		label16.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label21 = new JLabel("");
		label21.setName("21");
		label21.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label23 = new JLabel("");
		label23.setName("23");
		label23.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label25 = new JLabel("");
		label25.setName("25");
		label25.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label27 = new JLabel("");
		label27.setName("27");
		label27.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/grey.png")));
		...
		label30 = new JLabel("");
		label30.setName("30");
		label30.setIcon(new ImageIcon(CheckersBoardServerGUI.class
		...
		label32 = new JLabel("");
		label32.setName("32");
		label32.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label34 = new JLabel("");
		label34.setName("34");
		label34.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label36 = new JLabel("");
		label36.setName("36");
		label36.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label41 = new JLabel("");
		label41.setName("41");
		label41.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label43 = new JLabel("");
		label43.setName("43");
		label43.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label45 = new JLabel("");
		label45.setName("45");
		label45.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label47 = new JLabel("");
		label47.setName("47");
		label47.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/black.png")));
		...
		label50 = new JLabel("");
		label50.setName("50");
		label50.setIcon(new ImageIcon(CheckersBoardServerGUI.class
		...
		label52 = new JLabel("");
		label52.setName("52");
		label52.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label54 = new JLabel("");
		label54.setName("54");
		label54.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label56 = new JLabel("");
		label56.setName("56");
		label56.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label61 = new JLabel("");
		label61.setName("61");
		label61.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label63 = new JLabel("");
		label63.setName("63");
		label63.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label65 = new JLabel("");
		label65.setName("65");
		label65.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label67 = new JLabel("");
		label67.setName("67");
		label67.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label70 = new JLabel("");
		label70.setName("70");
		label70.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label72 = new JLabel("");
		label72.setName("72");
		label72.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label74 = new JLabel("");
		label74.setName("74");
		label74.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		label76 = new JLabel("");
		label76.setName("76");
		label76.setIcon(new ImageIcon(CheckersBoardServerGUI.class
				.getResource("/img/yellow.png")));
		...
		gbc_panelHistory.gridy = 0;
		panel_1.add(panelHistory, gbc_panelHistory);
	...
	protected void actionPerformedFunction(ActionEvent e) {
		if (server != null) {
			server.stop();
			server = null;
	...
	protected void mouseClickedFunction(MouseEvent e) {
		if (e.getClickCount() == 1) {
			if (action && board.getWhoisplaying() == Pawn.GREY) {
				...
				if (board.getBoard(newRow, newColumn).getType() == Pawn.EMPTY && board.takingTheJump(oldRow, oldColumn, newRow, newColumn)) {
						...
						if(!board.eatMore(newRow, newColumn)){
							appendGameStatus(">You moved from (" + oldPosition
									+ ") to (" + newPosition + ").\n");
							appendGameStatus(">It's the Client's turn.\n");
							
						} 
						
							board.mustTakeTheJump = false;
						
						server.sendMessage("Server moved from (" + oldPosition
								+ ") to (" + newPosition + ").");
				...
				if (board.getWhoisplaying() == Pawn.GREY
						&& board.getBoard(x, y).getType() == Pawn.GREY) {
					action = true;
	...
	public static void main(String[] arg) {
		new CheckersBoardServerGUI(1500).setVisible(true);
	}
